...
RecentCounter.prototype.ping = function(t) {
    const newNode = new LinkedList(t);
    if (this.windowHead === null) {
        this.windowHead = newNode;
        this.windowTail = this.windowHead;
        this.size++;
    } else {
        this.windowTail.next = newNode;
        this.windowTail = this.windowTail.next;
        this.size++;

        while(this.windowHead.val < t - 3000) {
            this.windowHead = this.windowHead.next;
            this.size--;
        }
    }
    return this.size;
